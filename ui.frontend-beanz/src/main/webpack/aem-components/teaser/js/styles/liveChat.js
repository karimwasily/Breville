...
function callLiveChat(_cache, callback) {
    ...
    liveagent.addButtonEventHandler(_cache.config.buttonId, function (e) {
        if (e === liveagent.BUTTON_EVENT.BUTTON_AVAILABLE) {
            ...
            document.querySelector(".cmp-teaser--livechat").classList.add("liveAgentAvailable");
            ...
            document.querySelector(".cmp-teaser--livechat").classList.add("liveAgentNotAvailable");
        }
        callback();
    });
...
function init() {
    const _cache = {};
    _cache.section = document.querySelector('.cmp-container--livechat .cmp-teaser--livechat');
...
(function(){
    ...
    script.src = "https://c.la2-c1cs-iad.salesforceliveagent.com/content/g/js/49.0/deployment.js";
    document.head.appendChild(script);
    script.onload = () => {
       const scriptLoaded = isScriptLoaded('https://c.la2-c1cs-iad.salesforceliveagent.com/content/g/js/49.0/deployment.js');
       if(scriptLoaded){
        init();
       }
    };  
