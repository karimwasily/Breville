...
export default class Slider extends React.Component {
  ...
  render() {
    ...
    // * (REVERTED BACK TO ORIGINAL) disable force slidesToScroll to be 1 when centerMode is enabled
        ...
        for (let k = j; k < j + settings.slidesPerRow; k += 1) {
          ...
          row.push(
            React.cloneElement(children[k], {
              ...
              tabIndex: -1,
              style: {
                ...children[k].props.style, // adding custom styles received as props to default styles
