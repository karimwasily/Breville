...
export class PrevArrow extends React.PureComponent {
  ...
  render() {
    ...
    if (this.props.prevArrow) {
      // adding custom class names received as props to list of default class names
      if (this.props.prevArrow.props && this.props.prevArrow.props.className) {
        prevArrowProps.className = `${prevArrowProps.className} ${this.props.prevArrow.props.className}`;
      }
...
export class NextArrow extends React.PureComponent {
  ...
  render() {
    ...
    if (this.props.nextArrow) {
      // adding custom class names received as props to list of default class names
      if (this.props.nextArrow.props && this.props.nextArrow.props.className) {
        nextArrowProps.className = `${nextArrowProps.className} ${this.props.nextArrow.props.className}`;
      }
