...
export default {
    ...
    decorators: [
        aemMetadata({
            decorationTag: {
                cssClasses: ['progressbar', 'component', StyleSystem, Grid],
                tagName: 'div'
            }
        })
    ],
...
const emptyContentPath = "/content/breville-brands-style-system/progressbar/jcr:content/root/container/container/empty";
export const empty = () => ({
