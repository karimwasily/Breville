...
export default {
    title: 'Components/commerce',
    decorators: [
        aemMetadata({
            decorationTag: {
                cssClasses: ['commerce', 'component', StyleSystem, Grid],
                tagName: 'div'
            }
        })
    ],
...
const emptyContentPath = "/content/breville-brands-style-system/commerce/jcr:content/root/container/container/empty";
export const empty = () => ({
